...
class UserAdmin(BotAdmin, admin.ModelAdmin):
    ...
    list_display = ('user_id', 'status', 'used_tokens', 'time_sub', 'end_time', 'sub_type', 'email', 'last_message','model', 'admin', 'blocked', 'utm_source', 'utm_campaign', 'phrase_id', 'device_type', 'ad_id')
