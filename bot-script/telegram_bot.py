...
❌ Анализ и генерация фото - доступно в подписках от 150 руб
...
При повторной покупке неиспользованные токены не переносятся''',
        ...
        # Mini🔸 < / b >
        # < blockquote >
        # 💰 < i > {prices_old[0]} < / i > < b > {prices_new[0]}
        # руб / 30
        # дней < / b >
        #
        # ⚙️ < b > GPT - 4 - mini < / b >: 500
        # тыс.
        #
        # 🔹 Чтение
        # файлов
...
<b>🔸Multi PRO x 2🔸</b> - временное предложение
<blockquote>
💰  <s><i>580</i></s>  <b>500 руб / 30 дней</b>

⚙️ Доступно токенов при использовании: 

    <b>GPT-4                      </b>: <s><i>500 тыс.</i></s> <b>1 млн.</b>
    <i>или</i>
    <b>GPT-4-mini и GPT-4.1-nano  </b>: <s><i>5 млн.</i></s> <b>10 млн.</b>

🔹 Анализ фото
🔹 Генерация до 200 изображений 
🔹 Чтение файлов 
...
⚙️  Доступно токенов при использовании: 
    ...
    <b>GPT-4                     </b>: 100 тыс.
    <i>или</i>
    <b>GPT-4-mini и GPT-4.1-nano </b>: 1 млн.
...
⚙️  Доступно токенов при использовании:
    ...
    <b>GPT-4                      </b>: 200 тыс.
    <i>или</i>
    <b>GPT-4-mini и GPT-4.1-nano  </b>: 2 млн.
...
⚙️ Доступно токенов при использовании: 
    ...
    <b>GPT-4                      </b>: 500 тыс.
    <i>или</i>
    <b>GPT-4-mini и GPT-4.1-nano  </b>: 5 млн.
...
📢  Переключив модель с GPT-4 на GPT-4-mini или GPT-4.1-nano расход токенов снизится в 10 раз

<b>✨ Сравнение моделей:</b>
<blockquote>
GPT-4                  90% - самая умная
GPT-4-mini         82% - средняя без анализа фото
GPT-4.1-nano    80% - быстрая с анализом фото
...
🔹 1 фото для анализа gpt-4 весит 1500 токенов, для анализа gpt-4.1-nano 4000 токенов
🔹 Генерация 1 изображения стоит от 5000 токенов 
🔹 <b>Поддерживаются форматы файлов: pdf, pptx, xlsx, txt, docx</b> – бот читает текст из файлов и добавляет его к запросу
        ...
        try:
            ...
            if update.message.photo:
                ...
                if  model_name['model'] == 'gpt-4o-mini':
                    ...
                    await update.message.reply_text(
                        message_thread_id=get_thread_id(update),
                        text='Анализировать фото может только gpt-4 или gpt-4.1-nano. Чтобы сменить модель — введите команду /model',
                    )
                    try:
