...
class OpenAIHelper:
    ...
    async def get_chat_response_stream(self, chat_id: int, query: str, model_config: dict):
        """
        ...
        self.__add_to_history(chat_id, role="assistant", content=answer)
        tokens_used = str(self.count_tokens(self.conversations[chat_id], model_config['model']))
