...
def main():
    ...
    openai_config = {
        ...
        'assistant_prompt': os.environ.get('ASSISTANT_PROMPT', 'Ты полезный помощник'),
        ...
        'role': os.environ.get('ROLE', 'assistant'),
        # 'edit_role': False,
    ...
    telegram_config = {
        ...
        'shop_id': os.environ.get('SHOP_ID', None),
        'yookassa_key': os.environ.get('YOOKASSA_KEY', None),
